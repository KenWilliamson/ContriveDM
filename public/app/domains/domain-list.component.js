System.register(['@angular/core', '../menu/services/menu-service', '../business/credentials/credentials', './services/domain-list.service', '@angular/router-deprecated'], function(exports_1) {
    ...
    var core_1, menu_service_1, credentials_1, domain_list_service_1, router_deprecated_1;
        ...
        execute: function() {
            DomainListComponent = (function () {
                ...
                DomainListComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [credentials_1.Credentials, router_deprecated_1.Router, domain_list_service_1.DomainListService, menu_service_1.MenuService])
                ], DomainListComponent);
