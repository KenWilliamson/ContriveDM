System.register(['@angular/core', '@angular/http', '../../business/credentials/credentials', 'rxjs/Observable', 'rxjs/add/operator/do', 'rxjs/add/operator/map', 'rxjs/add/operator/catch'], function(exports_1) {
    ...
    return {
        setters:[
            ...
            function (_3) {}],
        execute: function() {
            EditUserService = (function () {
                function EditUserService(http) {
                    this.http = http;
                    this.userUrl = './rs/user';
                }
                EditUserService.prototype.getUser = function (id) {
                    var getUrl = this.userUrl + ("/" + id);
                ...
                EditUserService.prototype.updateUser = function (json) {
                    var creds = new credentials_1.Credentials();
            ...
            exports_1("EditUserService", EditUserService);
        }
    }
});
