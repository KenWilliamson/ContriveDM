System.register(['@angular/core', '@angular/http', '../../business/credentials/credentials', 'rxjs/Observable', 'rxjs/add/operator/do', 'rxjs/add/operator/map', 'rxjs/add/operator/catch'], function(exports_1) {
    ...
    return {
        setters:[
            ...
            function (_3) {}],
        execute: function() {
            DeleteDomainService = (function () {
                function DeleteDomainService(http) {
                    this.http = http;
                    this.domainUrl = './rs/domain';
                }
                DeleteDomainService.prototype.getDomain = function (id) {
                    var getUrl = this.domainUrl + ("/" + id);
                ...
                DeleteDomainService.prototype.deleteDomain = function (id) {
                    var deleteUrl = this.domainUrl + ("/" + id);
                    var creds = new credentials_1.Credentials();
                    var headers = new http_2.Headers();
                    headers.append('Authorization', 'Basic ' + creds.getToken());
                    var options = new http_2.RequestOptions({ headers: headers });
                ...
                DeleteDomainService.prototype.handleError = function (error) {
                    console.error(error);
                    return Observable_1.Observable.throw(error.json().error || 'Server error');
                };
                DeleteDomainService = __decorate([
                    core_1.Injectable(), 
                    __metadata('design:paramtypes', [http_1.Http])
                ], DeleteDomainService);
                return DeleteDomainService;
            })();
            exports_1("DeleteDomainService", DeleteDomainService);
        }
    }
});
//# sourceMappingURL=delete-domain.service.js.map