    ...
    return {
        ...
        execute: function() {
            EditDomainService = (function () {
                function EditDomainService(http) {
                    this.http = http;
                    this.domainUrl = './rs/domain';
                }
                EditDomainService.prototype.getDomain = function (id) {
                ...
                EditDomainService.prototype.updateDomain = function (json) {
                    var creds = new credentials_1.Credentials();
                ...
                EditDomainService.prototype.handleError = function (error) {
                    console.error(error);
                    return Observable_1.Observable.throw(error.json().error || 'Server error');
                };
                EditDomainService = __decorate([
                    core_1.Injectable(), 
                    __metadata('design:paramtypes', [http_1.Http])
                ], EditDomainService);
                return EditDomainService;
            })();
            exports_1("EditDomainService", EditDomainService);
        }
    }
});
//# sourceMappingURL=edit-domain.service.js.map