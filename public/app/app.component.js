System.register(['@angular/core', './business/credentials/credentials', './menu/menu.component', './menu/services/menu-service', './domains/domain-list.component', './users/user-list.component', './addDomain/add-domain.component', './addUser/add-user.component', './editDomain/edit-domain.component', './editUser/edit-user.component', './deleteDomain/delete-domain.component', './deleteUser/delete-user.component', './login/login.component', './logout/logout.component', '@angular/router-deprecated'], function(exports_1) {
    ...
    var core_1, credentials_1, menu_component_1, menu_service_1, domain_list_component_1, user_list_component_1, add_domain_component_1, add_user_component_1, edit_domain_component_1, edit_user_component_1, delete_domain_component_1, delete_user_component_1, login_component_1, logout_component_1, router_deprecated_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
