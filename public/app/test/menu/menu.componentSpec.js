System.register(['angular2/testing', '../../menu/menu.component', '../../business/credentials/credentials'], function(exports_1) {
    var testing_1, menu_component_1, credentials_1;
    return {
        setters:[
        ...
        execute: function() {
            testing_1.describe('MenuComponent', function () {
                ...
                testing_1.it('should set show', testing_1.inject([credentials_1.Credentials], function (creds) {
                    var comp = new menu_component_1.MenuComponent(creds);
