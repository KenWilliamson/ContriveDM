...
describe('Manager', function () {
    ...
    var domainName = "testabc.com";
    var domainId;
    var domainToUpdate;
    describe('#addDomain()', function () {

        it('should add, get, update, and delete a domain with out an ssl', function (done) {
            var req = {};
            req.domainName = domainName;
            req.upstreamServerIp = "123.456.789.123";
            req.listenPort = "80";
                                ...
                                if (!err && results) {
                                    domainManager.getDomain(domainId, function (findResult) {
                                        ...
                                        if (findResult) {
                                            ...
                                            req.ssl = {};
                                            req.ssl.listenPort = "";
                                            req.ssl.sslCertificate = "";
                                            req.ssl.sslCertificateKey = "";
                                            console.log("request in update domain: " + JSON.stringify(req));
                                            domainManager.updateDomain(req, function (updateresult) {
                                                if (updateresult.success) {
